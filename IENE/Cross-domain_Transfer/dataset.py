...
def load_nc_dataset(data_dir, dataname, sub_dataname=''):
    ...
    if dataname == 'twitch-e':
        ...
        # if sub_dataname not in ('Penn94', 'Amherst41', 'Cornell5', 'Johns Hopkins55', 'Reed98', 'Caltech36',
        # 'Berkeley13', 'Brown11', 'Columbia2', 'Yale4', 'Virginia63', 'Texas80',
        #                        'Bingham82', 'Duke14', 'Princeton12', 'WashU32', 'Brandeis99', 'Carnegie49'):
        if sub_dataname not in (
                'Penn94', 'Amherst41', 'Cornell5', 'Johns Hopkins55', 'Caltech36', 'Berkeley13', 'Brown11',
                'Columbia2', 'Yale4', 'Virginia63', 'Texas80',
                'Bingham82', 'Duke14', 'Princeton12', 'WashU32', 'Brandeis99', 'Carnegie49'):
...
def load_fb100_dataset(data_dir, filename):
    ...
    #for f in ['Penn94', 'Amherst41', 'Cornell5', 'Johns Hopkins55', 'Reed98', 'Caltech36', 'Berkeley13', 'Brown11',
             # 'Columbia2', 'Yale4', 'Virginia63', 'Texas80',
             # 'Bingham82', 'Duke14', 'Princeton12', 'WashU32', 'Brandeis99', 'Carnegie49']:
    for f in ['Penn94', 'Amherst41', 'Cornell5', 'Johns Hopkins55', 'Caltech36', 'Brown11',
         'Yale4', 'Texas80',
         'Bingham82', 'Duke14', 'Princeton12', 'WashU32', 'Brandeis99', 'Carnegie49']:
